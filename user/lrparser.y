...
LOrExp:	 LAndExp				{$$ = $1;}
		|LAndExp Y_OR LOrExp	{$$ = doLOrExp($1,$3);}
		;
		
LAndExp: EqExp					{$$ = $1;}
		|EqExp Y_AND LAndExp	{$$ = doLAndExp($1,$3);}
		;
		
EqExp:	 RelExp					{$$ = $1;}
		|RelExp Y_EQ EqExp		{$$ = doEqExp("==",$1,$3);}
		|RelExp Y_NOTEQ EqExp	{$$ = doEqExp("!=",$1,$3);}
		;
		
RelExp:	 AddExp						{$$ = $1;}
		|AddExp Y_LESS RelExp		{$$ = doRelExp("<",$1,$3);}
		|AddExp Y_GREAT RelExp		{$$ = doRelExp(">",$1,$3);}
		|AddExp Y_LESSEQ RelExp		{$$ = doRelExp("<=",$1,$3);}
		|AddExp Y_GREATEQ RelExp	{$$ = doRelExp(">=",$1,$3);}
		;
		
AddExp:	 MulExp					{$$ = $1;}
		|MulExp Y_ADD AddExp	{$$ = doAddExp("+",$1,$3);}
		|MulExp Y_SUB AddExp	{$$ = doAddExp("-",$1,$3);}
		;
		
MulExp:	 UnaryExp				{$$ = $1;}
		|UnaryExp Y_MUL MulExp	{$$ = doMulExp("*",$1,$3);}
		|UnaryExp Y_DIV MulExp	{$$ = doMulExp("/",$1,$3);}
		|UnaryExp Y_MODULO MulExp	{$$ = doMulExp("%",$1,$3);}
		;
